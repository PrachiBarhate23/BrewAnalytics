import { Search, Bell, Calendar, ChevronDown, UploadCloud } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 ml-8">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[#1ABC9C] text-white rounded-lg hover:bg-[#16a085] transition-colors text-sm font-medium"
            >
